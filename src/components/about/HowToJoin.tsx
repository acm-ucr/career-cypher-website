...
const HowToJoin = () => {
  return (
    <div className="mt-30 h-200 w-170 justify-items-center rounded-lg border-1 pt-2 pb-15">
      <Image className="h-80 w-166 rounded-lg" src={HowImage} alt="" />

      <p className="font-poppins pt-4 pb-4 text-3xl font-[1000]">
        HOW TO JOIN?
      </p>
